...
export function createCesiumIonImage(
...
export function createCesiumIonTerrain(
  xbsjEarthUi: XbsjEarthUi,
  info: { name: string; url: string }
) {
  const sceneTree = xbsjEarthUi.sceneTree
...
export function createCesiumIonModel(
  xbsjEarthUi: XbsjEarthUi,
  info: { name: string; url: string }
) {
  const sceneTree = xbsjEarthUi.sceneTree
...
export function createTiandiImage(
  item: { name: string; serverUrl: string },
  xbsjEarthUi: XbsjEarthUi
) {
  const sceneTree = xbsjEarthUi.sceneTree
  let maxZindex = searchMaxZindex(sceneTree, 'ESImageryLayer')

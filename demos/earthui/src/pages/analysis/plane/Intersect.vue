<template>
    <PopList :title="'交'" :showButton="true" @close="ok" @ok="scene" :leftButton="'计算'" :rightButton="'确认'"
        :showLeftButton="true">
        <LabelInput v-model="onePolyNameId" :disabled="false" :activeMode="onePolyId" :label="'多边形1'" :checkbox="true" :list="onePolyList"
            :checkboxFun="changeOnePolygonShow" :liClickFun=" changeOnePolygonId" :placeholder="'请选择多边形'">
        </LabelInput>
        <LabelInput v-model="twoPolyNmaeId" :disabled="false" :activeMode="twoPolyId" :label="'多边形2'" :checkbox="true" :list="twoPolyList"
            :checkboxFun="changeTwoPolygonShow" :liClickFun=" changeTwoPolygonId" :placeholder="'请选择多边形'">
        </LabelInput>
    </PopList>
</template>
...
// 选择第一个多边形
function changeOnePolygonId  (item: any)  {

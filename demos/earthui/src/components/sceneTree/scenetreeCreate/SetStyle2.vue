<template>
    <DraggablePopup2 v-if="props.isShow" :title="`${(scenetree && scenetree.name) ? scenetree.name : ''}-编辑器`"
        :width="1000" :height="'600px'" :left="300" :top="100" @close="changeCancel" :showButton="true" @ok="changeOk">
        <div class="set_style">
            <!-- 左侧列表 -->

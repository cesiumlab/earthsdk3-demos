(function () {
  ...
  Colorpicker.prototype = {
    ...
    render: function () {
      var tpl = `<div style="position: fixed; top: 0px; right: 0px; bottom: 0px; left: 0px;"></div>
				<div style="position: inherit; left: 157px;z-index: 100;display: flex;box-shadow: rgba(0, 0, 0, 0.3) 0px 0px 2px, rgba(0, 0, 0, 0.3) 0px 4px 8px;">
					<div style='width:180px;padding:10px;background: #f9f9f9;display: none;flex-flow: row wrap;align-content: space-around;justify-content: space-around;' class='color-palette'>
    ...
    setPosition(x, y) {
      var LEFT = parseInt(x - this.pancelLeft-157),
    ...
    changeViewByHsb: function () {
      ...
      util.css(this.elem_barPicker1, {
        left:
          (this.hsb.h / 360) * this.elem_barPicker1.parentNode.offsetWidth +
          "px",
      });
      var hex = "#" + this.rgbToHex(this.HSBToRGB(this.hsb));
      this.Opt.change(this.bindElem, hex);
  ...
  // Rgb 转 xe2Color
  window.cssColorToXe2Color = function cssColorToXe2Color(cssColor) {
    return cssColor.map((e) => e / 255 || 0);
  };

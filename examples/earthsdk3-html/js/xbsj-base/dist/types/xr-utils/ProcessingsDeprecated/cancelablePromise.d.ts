...
export type SetCancelFunc = (cancelFunc: (cancelError?: CancelError) => void) => void;
...
export type PromiseExecutorType<T> = (resolve: (value: T | PromiseLike<T>) => void, reject: (reason?: any) => void) => void;
/**
...
export type RegisterCancelFuncType = (cancelFunc: () => void) => void;
type InnerOptionsType = {
    cancelCheck: () => void;

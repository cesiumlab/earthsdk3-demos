<template>
    <RightList :title="'编辑'">
        ...
        <Button :name="'yidong'" :content="'移动'"
            :color="!editingIsDisabled ? 'rgba(88, 88, 93, 1)' : 'rgba(58, 118, 229, 1)'"
            :click="() => { positionEditing = !positionEditing }" :disabled="!editingIsDisabled"
        ...
        <Button :name="'SkipLOD'" :content="'SkipLOD'"
            ...
            :actived="czmskipLevelOfDetail" :left-button="true"></Button>
        ...
        <Button :name="'neirongbaoweihe'" :content="'内容包围盒'"
            ...
            :disabled="!isDisabled" :actived="czmDebugShowContentBoundingVolume" :left-button="true"></Button>
...
class ES3DTilesetController extends Destroyable {
    constructor(private _es3DTileset: ES3DTileset) {
        ...
        this.d(vue3Xe2Bind(czmDebugShowBoundingVolume, [this._es3DTileset, 'czmDebugShowBoundingVolume'], false));
        this.d(vue3Xe2Bind(czmDebugShowContentBoundingVolume, [this._es3DTileset, 'czmDebugShowContentBoundingVolume'], false));
    }
}
onMounted(() => {

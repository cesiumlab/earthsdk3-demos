...
import Navigator from "./pages/view/control/navigator/index.vue";
import Scale from "./pages/view/control/scale/index.vue";
import StatusBar from "./pages/view/control/status-bar/index.vue";

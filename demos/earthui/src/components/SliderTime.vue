...
.m-slider .trackTransition {
    transition: left 0.2s, width 0.2s, background 0.3s;
}

/* .m-slider:hover .u-slider-rail {
    background: #E3E3E3;
} */
...
.m-slider .u-slider-handle {
    ...
    border-radius: 50%;
    cursor: pointer;
    transition: width 0.1s, height 0.1s, border-color 0.1s, border-width 0.1s, transform 0.1s cubic-bezier(0.18, 0.89, 0.32, 1.28);
}
...
.m-slider .u-slider-handle .m-handle-tooltip .m-arrow::before {
    position: absolute;
    bottom: 0;
...
.m-slider .u-slider-handle .m-handle-tooltip .m-arrow::after {
    position: absolute;
    width: 8.97056275px;
    height: 8.97056275px;
    bottom: 0;
...
.m-slider .u-slider-handle:hover {
    width: 8px;
    height: 8px;
    border-width: 4px;
    outline: none;
...
.m-slider .u-slider-handle:hover .m-handle-tooltip {
    pointer-events: auto;
    opacity: 1;
    transform: translate(-50%, -50%) scale(1);
}

/* .m-slider .u-slider-handle:focus {
    width: 6px;
    height: 6px;
    border-width: 4px;
    outline: none;

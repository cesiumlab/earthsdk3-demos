...
const showCesium3DTilesInspector = toVR<boolean>(d, [
...
<template>
  <RightList :title="'调试'">
    <Button
      :name="'dixingtiaoshi'"
      :content="'地形调试'"
      :click="() => changeShowCesiumInspector()"
      :actived="showCesiumInspector"
      :left-button="true"
    ></Button>
    <Button
      :name="'wapiantiaoshi'"
      :content="'瓦片调试'"
      :click="() => changeShowCesium3DTilesInspector()"
      :actived="showCesium3DTilesInspector"
    ></Button>
  </RightList>
</template>

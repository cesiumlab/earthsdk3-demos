...
<template>
  <RightList :title="'引擎'" :isTop="true">
    <div class="engine_title">
      推荐搭配使用ESSS信令服务器软件,<a href="https://bjxbsj.cn/esss.html" target="_blank"
        >请点击此处下载</a
      >
    </div>
    <Button
      ...
      "
      :actived="openUeInstall || activeViewerType === 'ESUeViewer'"
      :left-button="true"
    ></Button>
    <Button
      :name="'qiehuan_cesium'"
      :content="'Cesium'"
      :actived="activeViewerType === 'ESCesiumViewer'"
      :click="
        () => {
    ...
    <Button
      :left-button="true"
      :name="'Openlayers'"
      :actived="activeViewerType === 'ESOlViewer'"
      :content="'Openlayers'"
      :click="
        () => {

 ...
 * @param sceneObject
 */
export const saveFlyInParams = (objm: ESObjectsManager, sceneObject: ESVisualObject) => {
 ...
 * @param treeItem
 */
export const calcFlyToParam = async (objm: ESObjectsManager, treeItem: SceneTreeItem) => {

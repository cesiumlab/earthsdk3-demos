...
export abstract class Dragger extends Destroyable {
  ...
  constructor(
    protected _event: PointerEvent,
    protected _xScale: Ref<number>
  ) {
    super()
...
export class StartTimeLineDragger extends Dragger {
  ...
  constructor(
    event: PointerEvent,
    xScale: Ref<number>,
    private _startTimeRef: Ref<number>
  ) {
    super(event, xScale)
...
export class LastTimeLineDragger extends Dragger {
  ...
  constructor(
    event: PointerEvent,
    xScale: Ref<number>,
    private _stopTimeRef: Ref<number>
  ) {
    super(event, xScale)
...
export class PlayingRectLineDragger extends Dragger {
  ...
  constructor(
    ...
    private _xbsjEarthUi: XbsjEarthUi,
    private _channelsRef: Ref<
      | {
          pathId: string
          flag: boolean

        ...
        <div class="popup_box" ref="popupBoxDom" :class="developContent ? '' : 'transform_border'">
            <div class="popup_header" ref="popupHeaderDom">
                <div class="popup_title" @pointerdown="pointerdown">
                    <div class="popup_title_span" v-if="iconName"><es-icon :name="iconName" :color="iconColor"
                            :size="iconSize" /></div>
                    {{ title }}
                ...
                <div class="popup_icon">
                    ...
                    <span class="develop_icon" @click.stop="checkFun()" v-if="checkIconIsShow"
                        ...
                        <es-icon :name="'weixuanzhong'"
                            :color="iconIschecked || hoverLineHeight === 0 ? '#5788FF' : '#fff'" :size="12" />
                    </span>
                    ...
                    <span class="develop_icon" @click="emits('close')" :title="'关闭'"
                        @mouseover.prevent="hoverLineHeight = 2" @mouseout.prevent="hoverLineHeight = -1">
                        <es-icon :name="'guanbi'" :color="hoverLineHeight === 2 ? '#5788FF' : '#fff'"
                            :size="12" /></span>
                </div>
            </div>
            ...
            <div disabled="false" class="dragMouse" @pointerdown="dragPointerdown" v-show="developContent">
            </div>
        </div>
    </teleport>
</template>

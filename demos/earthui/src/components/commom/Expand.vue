<template>
  <div class="dragEagle-box" ref="targetDiv">
    ...
    <div
      class="resize-x"
      v-show="showResize"
      :class="dragEnableY ? '' : 'resize-none'"
      @mousedown="dragEagleY"
      @mouseover.prevent="showBar = true"
      @mouseout.prevent="showBar = false"
      :style="{ opacity: opacityVal }"
    ></div>
    <div
      class="resize-y"
      v-show="showResize"
      :class="dragEnableX ? '' : 'resize-none'"
      @mousedown="dragEagleX"
    ></div>
  </div>
</template>

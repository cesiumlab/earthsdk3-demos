...
<template>
  <RightList :title="'全局效果调整'">
    <Button
      :name="'wenzibirang'"
      :content="'文字避让'"
      :actived="textAvoidance === true"
      :click="
        () => {
          textAvoidance = !textAvoidance
        }
      "
      :left-button="true"
    ></Button>
    <Button
      ...
      :click="
        () => {
          objType === 'fov' ? (objType = '') : (objType = 'fov')
        }
      "
      :left-button="false"
    ></Button>
    <Button
      :name="'dingweipeizhi'"
      :content="'定位配置'"
      :actived="objType === 'flyToBoundingSize'"
      :click="
        () => {
          objType === 'flyToBoundingSize' ? (objType = '') : (objType = 'flyToBoundingSize')
        }
      "
      :left-button="true"
    ></Button>
    <Button
      :name="'huamianbili'"
      :content="'画面比例'"
      :actived="objType === 'screenPercentage'"
      :click="
        () => {
          objType === 'screenPercentage' ? (objType = '') : (objType = 'screenPercentage')
        }
      "
      :left-button="false"
    ></Button>
    <Button
      :name="'kangjuchi'"
      :content="'抗锯齿方法'"
      :actived="objType === 'antiAliasingMethod'"
      :click="
        () => {
          objType === 'antiAliasingMethod' ? (objType = '') : (objType = 'antiAliasingMethod')
        }
      "
      :left-button="true"
    ></Button>
    <Button
      :name="'diqiuyouhuisebeijingyanse'"
      :content="'地球基础色'"
      :actived="objType === 'sceneGlobeBaseColor'"
      :click="
        () => {
          objType === 'sceneGlobeBaseColor' ? (objType = '') : (objType = 'sceneGlobeBaseColor')
        }
      "
      :left-button="true"
    ></Button>
    <Button
      :name="'beijingse'"
      :content="'场景背景色'"
      :actived="objType === 'sceneBackgroundColor'"
      :click="
        () => {
          objType === 'sceneBackgroundColor' ? (objType = '') : (objType = 'sceneBackgroundColor')
        }
      "
      :left-button="true"
    ></Button>

...
const debugData = () => {
    ...
    if (!lastSelectedItem || !lastSelectedItem.sceneObject || !(lastSelectedItem.sceneObject instanceof ES3DTileset)) return;
...
onMounted(() => {
    debugData()
    const timer = window.setInterval(() => { debugData() }, 1500);

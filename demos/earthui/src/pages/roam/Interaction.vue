...
<template>
  <RightList :title="'交互模式'">
    ...
    <Button
      :name="'diyirencheng'"
      :content="'第一人称'"
      :click="changeWalkMode"
      :actived="mode === 'Walk'"
    ></Button>
    <Button
      :name="'yanxianyundong'"
      :content="'沿线运动'"
      :click="changeLineMode"
      :actived="mode === 'Line'"
      :left-button="true"
    ></Button>
    <Button
      :name="'diqiuxuanzhun'"
      :content="'环绕地球'"
      :click="changeRotateGlobeMode"
      :actived="mode === 'RotateGlobe'"
    ></Button>
    <Button
      :name="'genzong'"
      :content="'跟踪'"
      :click="changeFollowMode"
      :actived="mode === 'Follow'"
      :left-button="true"
    ></Button>
    <Button
      :name="'zhongxinxuanzhong'"
      :content="'中心旋转'"
      :click="changeRotatePointMode"
      :actived="mode === 'RotatePoint'"
      :left-button="false"
    ></Button>
    ...
    <RotateGlobe :xbsjEarthUi="xbsjEarthUi" v-if="mode === 'RotateGlobe'"> </RotateGlobe>
  </RightList>
</template>

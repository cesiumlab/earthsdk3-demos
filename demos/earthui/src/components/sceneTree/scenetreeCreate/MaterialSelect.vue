<template>
  ...
  >
    <div class="selectMaterial">
      <div
        class="item"
        :class="{ active: currentUEMaterial == item }"
        v-for="(item, index) in props.tilesetUEMaterial"
        :key="index"
...
const props = withDefaults(
  defineProps<{
    isShow: boolean
    currentUEMaterial: string | undefined
    tilesetUEMaterial: any[]
  }>(),
  {}
)
// 分发事件

<template>
    <div>
        ...
        <LabelInput v-model="actorTag" :label="'actorTag'" :checkbox="true" :list="option" :liClickFun="changeActorTag"
            :placeholder="'请填入或者选择actorTag'" :listContent="'value'"></LabelInput>
...
const pos = (messages: { [key: string]: any }) => {
    ...
    const message = messages.childPickedInfo.uePickResult

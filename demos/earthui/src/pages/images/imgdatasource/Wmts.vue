...
const preview = () => {
  ...
  const format =
    selected.value.format.format === 'application/openlayers'
      ? 'image/png'
  ...
  const options = {
    ...
    tilingScheme: {
      type:
        selected.value.tileMatrixSet.params.tilingScheme === 'Geographic'
          ? 'GeographicTilingScheme'
          : selected.value.tileMatrixSet.params.tilingScheme === 'WebMercator'

    ...
    <div class="roam_moveOnLineMode">
      <div>
        ...
        <div class="check_box" @click.stop="pointIsChecked = !pointIsChecked">
          <es-icon
            :name="pointIsChecked ? 'checked' : 'unchecked'"
            :color="pointIsChecked ? '#fff' : '#3b3c40'"
            :size="22"
          />
        </div>
      </div>
      <div>
        ...
        <div class="check_box" @click.stop="lineIsChecked = !lineIsChecked">
          <es-icon
            :name="lineIsChecked ? 'checked' : 'unchecked'"
            :color="lineIsChecked ? '#fff' : '#3b3c40'"
            :size="22"
          />
        </div>
      </div>
      <div>
        ...
        <div class="check_box" @click.stop="polygonIsChecked = !polygonIsChecked">
          <es-icon
            :name="polygonIsChecked ? 'checked' : 'unchecked'"
            :color="polygonIsChecked ? '#fff' : '#3b3c40'"
            :size="22"
          />
        </div>
      </div>

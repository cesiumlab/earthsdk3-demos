<template>
  <TreeComp
    :tree="propTree as unknown as Tree<TreeItem>"
    @click.self="propTree.uiTree.clearAllSelectedItems()"
    @blur="propTree.uiTree.clearAllSelectedItems()"
  >
    <template v-slot:default="slotProps">
      <PropTreeItemCom
        :showCheckBox="showCheckBox"
        :treeItem="slotProps.treeItem as unknown as GroupPropTreeItem | LeafPropTreeItem"
        :key="slotProps.key"
        @callback="callback"
        :tree="propTree"
      >

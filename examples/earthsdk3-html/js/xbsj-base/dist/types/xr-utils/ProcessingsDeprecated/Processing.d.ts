...
export type Status = 'Initial' | 'Running' | 'Error' | 'Cancelled' | 'Cancelling' | 'Completed';
/**
 * @deprecated
 */
export type StartProcessingFuncTypeDeprecated<CompleteValueType, ProgressValueType, StartValueType extends any[]> = (options: {
...
export type FinishedResultType<CompleteValueType> = {
    status: 'Error';
    error: any;
} | {
    status: 'Cancelled';
...
export declare class ProcessingDeprecated<CompleteValueType = void, ProgressValueType = void, StartValueType extends any[] = []> extends Destroyable {
    ...
    cancelFunc?: ((cancelError?: CancelError) => void) | undefined;
    cancelledFunc?: ((cancelError?: CancelError) => void) | undefined;
    ...
    cancelFunc?: ((cancelError?: CancelError) => void) | undefined, // 取消回调
    cancelledFunc?: ((cancelError?: CancelError) => void) | undefined, // 取消回调
